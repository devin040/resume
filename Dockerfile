...
# user tree and then and clean up.
    ...
    echo "Using TeXLive 2020 repository." &&\
# see https://tex.stackexchange.com/questions/540429
...
# TODO: see which of these we dont need
...
apt-get install -f -y --no-install-recommends pandoc &&\
